...
{{< downloadthis ../../resources/Pupillometry/RAW/PupilData.zip label="PupilData.zip" dname= "PupilData" type="secondary" >}}
...
This is just the tip of the iceberg ❄️—**dplyr** is an incredible tool! If you want to explore its full potential, check out this tutorial: [R dplyr Tutorial \| Learn with Examples](https://sparkbyexamples.com/r-programming/r-dplyr-tutorial-learn-with-examples/)
:::
