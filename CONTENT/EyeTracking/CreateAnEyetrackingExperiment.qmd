...
Here's a brief summary: After a fixation cross, participants see either a circle or square. The circle predicts a reward will appear on the right side of the screen, while the square predicts an empty cloud will appear on the left.
