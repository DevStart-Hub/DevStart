...
As mentioned before, we will use PsychoPy to create our experimental design!! So let's install it (and also let's install spyder-kernels that will help us interact with Spyder that we will cover later and tobii_research). Type:

``` bash
pip install psychopy dvst-detox
```
...
7.  In the terminal, type: `pip install detox-eyetracking`
