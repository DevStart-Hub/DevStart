...
``` bash
pip install psychopy spyder-kernels tobii_research
```
...
You can find it [**here**](https://www.psychopy.org/download.html#download). Please download and install it following your operating system guidelines!
...
-   Open the script you just downloaded (TestInstallatioPsychopy.py) in Spyder ( use the open Icon or drag and drop the file on Spyder)
